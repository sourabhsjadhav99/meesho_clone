...
function Categories() {
  ...
  return (
    <div className="w-full flex flex-col items-center gap-10 justify-center px-4">
      <div className="flex">
        <h1 className="text-2xl md:text-4xl font-bold text-center">Top Categories to choose from</h1>
      </div>
      <div
        className="flex flex-wrap items-end gap-4 p-6 md:p-10 w-full md:w-[75%] h-auto bg-no-repeat bg-cover rounded-md"
        style={{ backgroundImage: `url(${fashion_forward})` }}
      >
        <button
          onClick={() => {
        ...
        >
          <img className="rounded-sm w-full h-full md:w-auto md:h-auto" src={women_store} alt="women_store" />
        </button>
        <button
          onClick={() => {
            dispatch(addMultipleCategories(["mens-shirts", "mens-watches"]));
        ...
        >
          <img className="rounded-xl w-full h-full md:w-auto md:h-auto" src={mens_store} alt="mens_store" />
        </button>
        <button
          onClick={() => {
            dispatch(addMultipleCategories(["tops", "womens-shoes"]));
        ...
        >
          <img className="rounded-xl w-full h-full md:w-auto md:h-auto" src={kids_store} alt="kids_store" />
        </button>
      </div>

      <div
        className="flex flex-wrap items-center justify-around gap-4 w-full md:w-[75%] h-auto bg-no-repeat bg-cover rounded-md p-6"
        style={{ backgroundImage: `url(${essentials})` }}
      >
        <button
          className="w-[180px]"
        ...
        >
          <img className="w-full h-full" src={view} alt="view" />
        </button>
        <div className="flex flex-wrap gap-4">
          <button
            className="flex flex-col justify-between gap-3 w-full md:w-auto"
            onClick={() => {
              dispatch(addMultipleCategories(["home-decoration"]));
              navigate("/category");
            }}
          >
            <img className="rounded-xl w-full h-full" src={home_decor} alt="home_decor" />
          ...
          >
            <img className="rounded-xl w-full h-full" src={kitchen_appliances} alt="kitchen_appliances" />
            <p className="text-xl text-center p-2 text-pink-800 font-bold bg-pink-100 rounded-xl">
              Kitchen Appliances
            </p>
          </button>
          ...
          >
            <img className="rounded-xl w-full h-full" src={health_care} alt="health_care" />
            <p className="text-xl text-center p-2 text-pink-800 font-bold bg-pink-100 rounded-xl">
              Health Care
            </p>
          </button>
      ...
      >
        ...
        <div className="flex flex-wrap gap-4">
          ...
          >
            <img className="rounded-xl w-full h-full" src={accessories} alt="accessories" />
            <p className="text-xl text-center p-2 text-pink-800 font-bold bg-pink-100 rounded-xl">
              Accessories
            </p>
          </button>
          ...
          >
            <img className="rounded-xl w-full h-full" src={footwares} alt="footwares" />
            <p className="text-xl text-center p-2 text-pink-800 font-bold bg-pink-100 rounded-xl">
              Footwares
            </p>
          </button>
          ...
          >
            <img className="rounded-xl w-full h-full" src={electronics} alt="electronics" />
            <p className="text-xl text-center p-2 text-pink-800 font-bold bg-pink-100 rounded-xl">
              Electronics
            </p>
          </button>
      ...
      <div
        className="flex flex-col items-end gap-4 p-6 md:p-12 w-full md:w-[75%] h-auto bg-no-repeat bg-cover rounded-md"
        style={{ backgroundImage: `url(${online_buisness})` }}
      >
        <h1 className="text-blue-500 text-2xl md:text-3xl mb-2">Become a Reseller and</h1>
        <h1 className="text-pink-800 text-3xl md:text-5xl font-bold">
          Start your Online Business
        </h1>
        <h1 className="text-pink-800 text-3xl md:text-5xl font-bold">
          with Zero Investment
        ...
        <div className="flex gap-3 mt-10">
          <button
            className="w-[140px] md:w-[180px] h-[48px]"
            onClick={handleplayButtonClick}
          >
            <img
              src={playstore}
          ...
          <button className="w-[140px] md:w-[180px] h-[48px]" onClick={handleAppButtonClick}>
            <img
              src={appstore}
              alt="appstore"
              className="w-full h-full rounded-md"
      ...
      <div
        className="flex flex-col items-start gap-5 p-6 md:p-12 w-full md:w-[75%] h-auto bg-no-repeat bg-cover rounded-md text-white"
        style={{ backgroundImage: `url(${supplier})` }}
      >
        ...
        <div className="flex flex-wrap w-full md:w-[70%] text-lg font-bold">
