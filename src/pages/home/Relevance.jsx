...
//         className="w-full flex justify-between p-3 items-center border-2 border-transparent active:border-gray-500 duration-300 rounded"
//       >
//         <div>
//           <span className="text-gray-400">Sort by : </span>
//           <span className="text-black font-medium">Relevance</span>
//         </div>
//         <div className="text-2xl">
